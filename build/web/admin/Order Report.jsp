<%-- 
    ...
    Created on : 21 May, 2022, 8:33:28 AM
    Author     : user
--%>
...
.style22 {font-size: 18px; color: #FFFFFF; }
...
<table width="1285" bordercolor="#006699">
  <tr>
    <th width="279" height="486" align="center" valign="top" bgcolor="#00CCCC"class="style6" scope="row"><div align="center">
      ...
      <p class="style7">
        <label>
        <input name="button" type="button" class="style7" value="Order Report"/>
        </label>
      </p>
      <p class="style7">
        <label>
    ...
    <td width="994" align="center" valign="top"><table width="998" border="0">
      <tr bgcolor="#00CCCC">
        <th width="945" height="52" bgcolor="#00CCCC" scope="row"><span class="style21">Order Report </span></th>
      </tr>
    </table>
      <p>&nbsp;</p><div id="export">
      <table width="980" border="1" align="center" class="styled-table">
      <tr bgcolor="#999999">
        <th width="81" height="41" border="1"><div align="center" class="style20">Order Id</div></th>
        <th width="76" border="1"><div align="center" class="style20">Reg Id</div></th>
        <th width="129" border="1"><div align="center" class="style20">Product Id</div></th>
        <th width="122" border="1"><div align="center" class="style20">User Name</div></th>
        <th width="120" border="1"><div align="center" class="style20">Product Name</div></th>
        <th width="96" border="1"><div align="center" class="style20">Price</div></th>
        <th width="91" border="1"><div align="center" class="style20">Quantity</div></th>
          <th width="110" border="1"><div align="center" class="style20">Total Amount</div></th>
        <th width="97" border="1"><div align="center" class="style20">Order Date</div></th>
       </tr>
      <% while(rs.next())
        { 
  ...
  <table width="1289" height="51" >
   <tr>
     <td width="1259" bgcolor="#669999"><span class="style19">
       ...
       </span>       <footer><p align="center" class="style22">Developed By: Pawar Akanksha and Pawar Pratiksha</p>
       </footer>
     </td>
   </tr>
 </table>
