...
<%-- 
    ...
    Created on : 21 May, 2022, 9:15:08 AM
    Author     : user
--%>
    ...
    try
      {
       ...
       String query="select * from feedbk";
        out.println(query);
...
.style24 {color: #FFFFFF; font-weight: bold; font-size: 18px; }
...
<table width="1285" bordercolor="#006699">
  <tr>
    <th width="279" height="486" align="center" valign="top" bgcolor="#00CCCC"class="style6" scope="row"><div align="center">
      ...
      <p class="style19"> <%out.println(session.getAttribute("email"));%></p>
       <p class="style7">
        <label>
      ...
      <p class="style7">
        <label>
        <input name="button" type="button" class="style7" value="Feedback Report"/>
        </label>
      </p>
      <p class="style7">
        <label>
    ...
    <td width="994" align="center" valign="top"><table width="998" border="0">
      <tr bgcolor="#00CCCC">
        <th width="945" height="52" bgcolor="#00CCCC" scope="row"><span class="style21">Feedback Report </span></th>
      </tr>
    </table>
      <p>&nbsp;</p><div id="export">
      <table width="980" border="1" align="center" class="styled-table">
          <tr bgcolor="#999999">
        <th width="113" height="44" border="1"><div align="center" class="style23">
          <div align="center"><strong>Feedback Id</strong></div>
        </div></th>
        <th width="174" border="1"><div align="center" class="style24">
          <div align="center">name </div>
        </div></th>
        <th width="143" border="1"><div align="center" class="style24">
